    ...
    <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-item active">
        <div class="carousel-container">
          <img src="assets/img/logo.jpg" class="img-fluid animated" width="250" height="50">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="icon-box" data-aos="zoom-in-left">
              <div class="icon"><i class="bi bi-lightning-charge" style="color: #ff689b;"></i></div>
              <h4 class="title" padding-top="10%">Electrical & Electronic Repair</h4>
          ...
          <div class="col-lg-4 col-md-6 mt-5 mt-md-0">
            <div class="icon-box" data-aos="zoom-in-left" data-aos-delay="100">
              <div class="icon"><i class="bi bi-snow" style="color: #e9bf06;"></i></div>
              <h4 class="title">Air conditioning and refrigeration supply & repair</h4>
          ...
          <div class="col-lg-4 col-md-6 mt-5 mt-lg-0 ">
            <div class="icon-box" data-aos="zoom-in-left" data-aos-delay="200">
              <div class="icon"><i class="bi bi-broadcast-pin" style="color: #3fcdc7;"></i></div>
              <h4 class="title">Power supply & telecommunications cabling works</h4>
              <p class="description">A reliable partner for providing power system communication networks.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mt-5">
            <div class="icon-box" data-aos="zoom-in-left" data-aos-delay="400">
              <div class="icon"><i class="bi bi-cloud-fog2" style="color: #d6ff22;"></i></div>
              <h4 class="title">Fogging maintenance work</h4>
          ...
          <div class="col-lg-4 col-md-6 mt-5">
            <div class="icon-box" data-aos="zoom-in-left" data-aos-delay="500">
              ...
              <h4 class="title">Sewage maintenance work</h4>
